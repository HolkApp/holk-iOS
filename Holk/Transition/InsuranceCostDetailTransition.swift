...
final class InsuranceCostDetailTransition: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        if let insuranceOverviewViewController = transitionContext.viewController(forKey: .from) as? InsuranceOverviewViewController,
            ...
            let toViewController = transitionContext.viewController(forKey: .to) as? InsuranceCostDetailViewController {
    ...
    private func push(_ transitionContext: UIViewControllerContextTransitioning, fromViewController: InsuranceCostViewController, toViewController: InsuranceCostDetailViewController) {
