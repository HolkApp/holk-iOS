...
struct LocalizedString {
    ...
    enum Insurance {
        ...
        enum Aggregate {
            ...
            static let addInsurance = NSLocalizedString("Insurance.Aggregate.AddInsurance", value: "Add insurance", comment: "Header text to let the user to aggregate the insurance")
